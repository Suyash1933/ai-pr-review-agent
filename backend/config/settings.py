...
class Settings(BaseSettings):
    ...
    # Callback URL: http://localhost:8001/api/v1/auth/callback (dev)
    ...
    # Base URL for webhook callbacks (ngrok URL in dev, production URL in prod)
