...
class PRReviewState(TypedDict):
    ...
    # The user who owns this review (multi-user OAuth).
    # Empty string for legacy/pre-OAuth reviews that use the global GITHUB_TOKEN.
    # WRITTEN BY: orchestrator from enqueued job data
    # READ BY: build_context (to resolve per-user GitHub token), post_review, save_review
    user_id: str
