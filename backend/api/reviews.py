...
from backend.auth.current_user import get_optional_user
...
async def list_reviews_endpoint(
    ...
    """
    # If a user is logged in via OAuth, scope results to their reviews only.
    # API-key auth (no user) returns all reviews (admin view).
