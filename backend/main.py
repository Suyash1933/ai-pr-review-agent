...
from backend.api.auth_router import router as auth_router  # GitHub OAuth + user management
...
app.include_router(auth_router)           # GitHub OAuth: login, callback, me, logout, repos
